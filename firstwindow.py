...
class Application(FuncoesDosBotoes):
    ...
    def tela(self):
        self.janela.title('CADASTRO DE LIVROS')
    ...
    def criar_botoes(self):
        ...
        #Botão para retornar todos os livros
        self.bt_todos = Button(self.frame_1, text='todos os livros', bd=0.5, fg='white', bg='#001242', font=('monospace', 7, 'bold'), command=self.mostrar_livros)
        self.bt_todos.place(relx=0.8, rely=0.1, relwidth=0.18, relheight=0.15)
